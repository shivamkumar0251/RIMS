            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`mt-1 block w-full rounded-md border px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors ${
                    errors.franchiseName ? "border-red-500" : "border-gray-300 hover:border-gray-400"
                  }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`mt-1 block w-full rounded-md border px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors ${
                    errors.ownerName ? "border-red-500" : "border-gray-300 hover:border-gray-400"
                  }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`mt-1 block w-full rounded-md border px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors ${
                    errors.gstNumber ? "border-red-500" : "border-gray-300 hover:border-gray-400"
                  }`}
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <input
                    ...
                    className={`mt-1 flex-1 rounded-md border px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors ${
                      errors.oldPassword ? "border-red-500" : "border-gray-300 hover:border-gray-400"
                    }`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handlePasswordChange}
                  className={`mt-1 block w-full rounded-md border px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors ${
                    errors.newPassword ? "border-red-500" : "border-gray-300 hover:border-gray-400"
                  }`}
