  ...
  const handleSaveVendor = async (data: any) => {
    try {
      const mappedData: any = {
        ...
        vendor_mobileNo: data.vendor_mobileNo,
        vendor_bankName: data.vendor_bankName,
        vendor_accountNumber: data.vendor_accountNumber,
        vendor_ifscCode: data.vendor_ifscCode,
        vendor_branchName: data.vendor_branchName,
        vendor_paymentTerms: data.vendor_paymentTerms,
        vendor_preferredPaymentMode: data.vendor_preferredPaymentMode,
        vendor_creditLimit: Number(data.vendor_creditLimit) || 0,
        vendor_outstandingBalance: Number(data.vendor_outstandingBalance) || 0,
        vendor_gstType: data.vendor_gstType,
        vendor_registrationType: data.vendor_registrationType,
        vendor_gstNumber: data.vendor_gstNumber,
        vendor_openingBalance: Number(data.vendor_openingBalance) || 0,
        vendor_city: data.vendor_city,
        vendor_landmark: data.vendor_landmark,
        vendor_contactPerson_name: data.vendor_contactPerson_name,
